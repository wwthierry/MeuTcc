...
// IMPORTANTE: Os dados serão perdidos a cada reinício do servidor.
// Em produção, isso seria substituído por um banco de dados persistente.
let posts = [];
let comments = {};
let likes = {};
let postIdCounter = 1;
...
app.post('/api/posts/:id/like', (req, res) => {
  ...
  if (userLikeIndex > -1) {
    ...
    likes[postId].push({ userId, createdAt: new Date().toISOString() });
